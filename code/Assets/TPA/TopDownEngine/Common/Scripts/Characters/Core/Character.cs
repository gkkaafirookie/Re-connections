...
namespace MoreMountains.TopDownEngine
{
	...
	public class Character : NetworkBehaviour 
	{
		...
		public void Start()
		{
			...
			CharacterBrain.OnSpawned();

			foreach(var _characterAbilitie in _characterAbilities)
            {
				_characterAbilitie.OnSpawned();
        ...
        {
			_controller.OnEarlyFixedUpdate();
			CharacterBrain.OnEarlyFixedUpdate();
		}
